...
class SkyDetector():
    ...
    def _load_checkpoint(self):
        #TODO best_CKPT.pt dolad
        if os.path.exists(os.path.join(self.checkpoint_dir, 'best_ckpt.pt')) and (os.path.exists(os.path.join(self.checkpoint_dir, 'last_ckpt.pt')) == False) :
            print('loading best checkpoint...')
            # load the entire checkpoint
            checkpoint = torch.load(os.path.join(self.checkpoint_dir, 'best_ckpt.pt'))
